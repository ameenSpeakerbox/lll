    ...
    <Layout>
      ...
      <div className="gatsby" style={{ overflow: "hidden" }}>
        <Row className="first-section" style={{ background: "black" }}>
          ...
          >
            <p className="desc clr-white">
              <>
                Want to get more visits thanks to blazing-fast and SEO-friendly
                websites?
              </>
            </p>
          </Col>
        ...
        <div className="sec-section">
          <Container>
            <h2 className="title pt-5" style={{ fontWeight: "400" }}>
              <>What is</>
              <span style={{ color: "#EE3958", fontWeight: "600" }}>
                <>&nbsp;Gatsby JS?</>
              </span>
            </h2>
            <p className="content">
              <>
                ...
                What does that even mean? Well it weaves together the best parts
                of React webpack react-router GraphQL and other front-end tools
                in to one ultimate package
              </>
            </p>

            <h2 className="title pt-3" style={{ fontWeight: "400" }}>
              <>Why do we use</>
              <span style={{ color: "#EE3958", fontWeight: "600" }}>
                <>&nbsp;Gatsby JS?</>
              </span>
            ...
            <p className="content">
              <>
                Below are the list of advantages of hiring a Gatsby development
                agency for your next web development project
              </>
            </p>
            ...
            <div className="features mt-4">
              ...
              <p className="content">
                <>
                  Now stop losing clients and business due to poor performing
                  websites with too much loading time Delight users with a
                  website that works with a blink of an eye
                </>
              </p>
            </div>
            ...
            <div className="features mt-4">
              ...
              <p className="content">
                <>
                  Rank your page easier and higher than your competition Google
                  favours static pages as they are fast light and easy to scan
                </>
              </p>
            </div>
            ...
            <div className="features mt-4">
              ...
              <p className="content">
                <>
                  UX can make or break your business performance Now you can
                  deliver a truly outstanding and customized page without
            ...
            <div className="features mt-4">
              ...
              <p className="content">
                <>
                  Gatsby’s serverless rendering generates static HTML at build
                  time No server and no reachable database equals no malicious
                  requests DDOS attacks or accidental exposure
                </>
            ...
            <div className="features mt-4 pb-5">
              ...
              <p className="content">
                <>
                  Every website is an app and every app is a website Gatsbyjs is
                  a future maker It makes the web a better place Less noisy more
            ...
            <div className="pb-5 mx-auto d-block">
              <Link to="" className="button pink-btn">
        ...
        <div className="third-section">
          <Container>
            ...
            <p className="data-source clr-white">
              <>DATA SOURCES</>
            </p>
            ...
            <p className="data-source clr-white pt-3">
              <>DEPLOY & CDN</>
            </p>
            <Row className="justify-content-center">
        ...
        <div className="fourth-section">
          <Container className="py-5">
            <h2 className="title">
              <>Why</>
              <span style={{ color: "#744C9E" }}>
                {" "}
                <>Gatsby</>
              </span>{" "}
              <>Developers from</>{" "}
              <span style={{ color: "#EE3958" }}>
                <>speakerbox ?</>
              </span>
            </h2>
            ...
            <Row className="my-3">
              <Col className="icon-col">
                <img
                  src={groupIcon}
                  alt="groupIcon"
                  className="icon d-block m-auto"
                />
              </Col>

              <Col>
                <h4 className="head">
                  <>Efficient Experienced and Innovative Team of Developers</>
                </h4>

                <p>
                  <>
                    Our team has been working on Gatsby since its existence and
                    we have a team of young energetic UI/UX Designers and
                    Developers who work under the same roof to bring out optimal
                    results
                  </>
                </p>
              </Col>
            ...
            <Row className="my-3">
              ...
              <Col>
                ...
                <p>
                  <>
                    Gatsby’s flexibility allows you to do online business easier
                    and much more efficient We know how to use this unfair
                    advantage a lot
                  </>
                </p>
              </Col>
            ...
            <Row className="my-3">
              ...
              <Col>
                <h4 className="head">
                  <>We’re Gatsby Partner Agency</>
                </h4>

                <p>
                  <>
                    We are one of the only few partner agencies in the region
                    with 100% customer satisfaction Our team’s broad
                    understanding of gatsby makes us the perfect choice for your
                    next project
                  </>
                </p>
              </Col>
