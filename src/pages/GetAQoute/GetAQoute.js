                        ...
                        <div className="grid md:grid-cols-2">
                            <div>
                                ...
                                <div className="grid md:grid-cols-1 grid-cols-1 gap-5 mt-16">
                                    ...
                                    <InputField width={'w-full'} label={'Company Name'} name={'type_of_service'} value={CommercialFormData.type_of_service} onchange={handleCommercialFormChange} />
                                    <h3 className='font-semibold'>Type of Cargo</h3>
                                    <InputField width={'w-full'} label={'Company '} name={'type_of_cargo'} value={CommercialFormData.type_of_cargo} onchange={handleCommercialFormChange} />
                                </div>
                            </div>
                        </div>
